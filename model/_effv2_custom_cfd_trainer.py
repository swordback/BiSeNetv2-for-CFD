...
from .effv2_custom_cfd import BiSeNetV2
from tqdm import tqdm

class Effv2_custom_cfd_Trainer(_BaseTrainer):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.model_name = 'Effv2_custom_cfd'
    ...
    def _get_model(self, run_number):
        ...
        model = BiSeNetV2(n_classes=2, aux_mode='eval')
